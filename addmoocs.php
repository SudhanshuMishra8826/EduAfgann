    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <thead>
                ...
                <th colspan="2" scope="col">Upload MOOCs</th>      
                </tr>
            </thead>
            <tbody>
                
                <form action="storemooc.php" method="post" enctype="multipart/form-data">
                <tr style="margin-top: 0px; border-top: solid; border-color:#4db8ff;">
                <td> Title: <input type="text" name="title"></td>
                <td> Course Website: <input type="text" name="website"></td>
                </tr>
                <tr>
                <td> Course Providee: <input type="text" name="provider"></td>
                <td> Description: <input type="textarea" name="desc"></td>
                </tr>
                <tr>
                <td> Couser Link: <input type="text" name="link"></td>
                </tr>
