    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <thead>
                ...
                <th colspan="2" scope="col">Upload Scolarship</th>      
                </tr>
            </thead>
            <tbody>
                
                <form action="storescholarship.php" method="post" enctype="multipart/form-data">
                <tr style="margin-top: 0px; border-top: solid; border-color:#4db8ff;">
                <td> Title: <input type="text" name="title"></td>
                <td> Scolarship Source: <input type="text" name="source"></td>
                </tr>
                <tr>
                <td> Description: <input type="textarea" name="desc"></td>
                </tr>
                <tr>
                <td> Scolarship Link: <input type="text" name="link"></td>
                </tr>
