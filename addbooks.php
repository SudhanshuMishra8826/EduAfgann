    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <thead>
                ...
                <th colspan="2" scope="col">Upload Books</th>      
                </tr>
            </thead>
            <tbody>
                ...
                <form action="<?php 
                if($_GET['bookid']=='1'){
                echo 'upload.php?bookid=1';}
                elseif($_GET['bookid']=='2'){
                echo 'upload.php?bookid=2';}
                elseif($_GET['bookid']=='3'){
                echo 'upload.php?bookid=3';}
                elseif($_GET['bookid']=='5'){
                echo 'upload.php?bookid=5';}
                 ?>" 
                 method="post" enctype="multipart/form-data">

                <td> Book Name: <input type="text" name="name"><br></td>
